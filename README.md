...
| `host/request-context@1.0.0.wit` | `astrid:request-context@1.0.0` | Opaque host-minted ownership for authenticated local connections, used to correlate interactive requests without trusting guest session fields. |
